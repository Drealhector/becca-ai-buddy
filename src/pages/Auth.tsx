...
const Auth = () => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-primary via-accent to-primary flex items-center justify-center p-4">
      <div className="w-full max-w-md bg-card rounded-2xl shadow-depth p-8 animate-scale-in">
        ...
        <Button onClick={handleGoogleSignIn} disabled={loading} className="w-full h-12 text-lg gap-3 bg-white hover:bg-white/90 text-foreground shadow-elegant">
