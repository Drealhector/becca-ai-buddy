      ...
      <div className="relative z-10 pointer-events-none min-h-screen flex flex-col">
        ...
        <div className="flex-1 flex items-end pb-16 md:pb-24">
          <div className="container mx-auto px-4 text-center max-w-5xl pointer-events-auto">
            <h1 className="text-2xl sm:text-3xl md:text-4xl lg:text-5xl xl:text-6xl font-bold text-white mb-4 md:mb-8 leading-tight px-2 flex flex-col items-center drop-shadow-[0_0_30px_rgba(100,150,255,0.3)]">
